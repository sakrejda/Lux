#ifndef SLICER_CONTINUOUS_NOLOG_H
#define SLICER_CONTINUOUS_NOLOG_H
...
class Slicer_Continuous_NoLog {

public:
	Slicer_Continuous_NoLog();
	Slicer_Continuous_NoLog(
		const T_PDF pdf,
		T_DOMAIN x_,
		T_DOMAIN domain_min,
...
template <class T_PDF, class T_DOMAIN> 
Slicer_Continuous_NoLog<T_PDF, T_DOMAIN>::Slicer_Continuous_NoLog() : 
...
template <class T_PDF, class T_DOMAIN> 
T_DOMAIN
Slicer_Continuous_NoLog<T_PDF, T_DOMAIN>::draw() {
	y = U(*R) * ppdf(x);
	step_out();
	while(true) {
...
template <class T_PDF, class T_DOMAIN> 
void Slicer_Continuous_NoLog<T_PDF, T_DOMAIN>::step_out() {
	l_bound = x - w * U(*R);
	r_bound = l_bound + w;
...
template <class T_PDF, class T_DOMAIN> 
void Slicer_Continuous_NoLog<T_PDF, T_DOMAIN>::jump(T_DOMAIN x_) {
